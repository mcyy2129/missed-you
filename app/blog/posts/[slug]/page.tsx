...
import ClientSocials from '@/components/blog/ClientSocials';
import ClientTOC from '@/components/blog/ClientTOC';
import BackButton from '@/components/blog/BackButton';
import Comments from '@/components/blog/Comments';
import SidebarLyric from '@/components/blog/SidebarLyric';
          ...
          <aside className="w-full lg:w-[320px] flex flex-col gap-6 flex-shrink-0">
            ...
            <div className="bg-white/60 dark:bg-slate-800/50 backdrop-blur-xl rounded-3xl p-6 border border-white/40 dark:border-white/10 shadow-xl">
              ...
              <div className="space-y-4">
                {recentPosts.map(p => (
                  <Link key={p.slug} href={`/blog/posts/${p.slug}`} className="group block">
