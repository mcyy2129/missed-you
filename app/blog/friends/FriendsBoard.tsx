...
import { friendsData } from '@/data/blog/friends';
import Comments from '@/components/blog/Comments'; // 🌟 引入你的 Gitalk 组件
import { siteConfig } from '@/siteConfig_blog'; // 🌟 引入刚刚更新的全局配置文件
